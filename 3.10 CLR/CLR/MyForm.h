...
namespace CLR {
	...
	public:
		...
		std::string find_max_vowel_word(const std::string sentence);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Size = System::Drawing::Size(403, 192);
			...
			this->label2->Text = L"—лово, с наибольшим числом гласных букв: ";
			// 
			// textBox2
			// 
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox2->Location = System::Drawing::Point(16, 272);
			this->textBox2->Name = L"textBox2";
			this->textBox2->ReadOnly = true;
			this->textBox2->Size = System::Drawing::Size(403, 25);
			...
			this->button1->Size = System::Drawing::Size(403, 38);
			this->button1->TabIndex = 4;
			this->button1->Text = L"¬ыполнить";
			...
			this->ClientSize = System::Drawing::Size(435, 358);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		std::string word = find_max_vowel_word(msclr::interop::marshal_as<std::string>(s));
		
		textBox2->Text = gcnew System::String(word.c_str());
	}
};
}
